...
const SignInScreen = ({navigation}) => {
    ...
    return (
      <View style={styles.container}>
          <StatusBar backgroundColor='#e6642e' barStyle="light-content"/>
        ...
        <Animatable.View 
            ...
            <View style={styles.button}>
                ...
                <LinearGradient colors={['#e6642e', '#e6642e']} style={styles.signIn} >
                ...
                >
                    <Text style={[styles.textSign, { color: '#e6642e'}]}>Sign Up</Text>
                </TouchableOpacity>
            </View>
        </Animatable.View>
      </View>
